...
const TRANSFORMATIONS = [
  ...
  { icon: '🌱', text: 'Consegue planejar um consórcio produtivo desde o início, sem depender de receituário externo.' },
...
const PAIN_CARDS = [
  {
    ...
    desc: 'Você entende por que a agricultura convencional degrada, o que é sintropia, como a sucessão natural funciona e qual é a arquitetura vertical da floresta. Com isso, as técnicas passam a fazer sentido — e você sabe onde corrigir quando algo dá errado.',
  },
  {
    label: 'Solo e Planejamento',
    title: 'Do solo ao consórcio produtivo',
    desc: 'Você aprende a construir fertilidade de dentro para fora, a ler a sua terra e a desenhar um consórcio funcional do zero. Sem depender de receituário externo.',
  },
  {
      ...
      <section style={{ backgroundColor: DARK }} className="py-28 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-gray-400 text-xl mb-16 max-w-2xl mx-auto leading-relaxed">
            Ao final, você entende a lógica da floresta, sabe ler a sua terra e consegue planejar um sistema produtivo sem depender de receituário externo. Você sai com o mapa antes de entrar na floresta.
          </p>
        ...
        <div className="max-w-xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="font-serif font-black text-white leading-tight mb-3"
              ...
              Comece com o mapa certo.<br />
              <span style={{ color: LIME }}>Antes da primeira enxada.</span>
            </h2>
          </div>
